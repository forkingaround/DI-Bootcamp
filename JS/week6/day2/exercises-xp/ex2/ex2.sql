...
-- Not satisfied with the results. Write a query which will find the next 10 cheapest 
-- movies.
...
-- the amount and the date of every payment made by a customer, ordered by their id 
-- (from 1 to…).
...
-- You need to check your inventory. Write a query to get all the 
-- movies which are not in inventory.
...
-- Bonus You want to be able to see how your sellers have 
-- been doing? Write a query to get the customer’s id, 
-- names (first and last), the amount and the date of 
-- payment ordered by the id of the staff member who sold 
-- them the dvd.
